 ...
 *
 */
public class ReminderOnDemandPrefrenceActivity extends PreferenceActivity {
	/**
...
//		String name = prefs.getString("name", sdf.format(new Date(id)));
...
//			if (Log.isLoggable(TAG_ACTIVITY, Log.DEBUG)){
//				Log.d(TAG_ACTIVITY, "New reminder[" + name +"] updated");
//			}
//		}
//		
//		

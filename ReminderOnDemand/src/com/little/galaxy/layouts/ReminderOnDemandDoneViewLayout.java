...
public class ReminderOnDemandDoneViewLayout extends LinearLayout{
	private TextView subject;
    private TextView Description;
    private ImageButton btn;

    public ReminderOnDemandDoneViewLayout(final Context context, final ReminderOnDemandEntity entity) {
    	
        super(context);
		SimpleDateFormat sdf=new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
		String desc =  "Remindered at " + sdf.format(new Date(entity.getExecTime()));
